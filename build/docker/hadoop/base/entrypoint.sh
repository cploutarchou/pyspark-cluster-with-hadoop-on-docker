...
if [ "$MULTIHOMED_NETWORK" = "1" ]; then
    ...
    addProperty /etc/hadoop/hdfs-site.xml dfs.client.use.datanode.hostname 0.0.0.0.0
    addProperty /etc/hadoop/hdfs-site.xml dfs.datanode.use.datanode.hostname 0.0.0.0
